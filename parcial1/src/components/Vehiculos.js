...
import React, { useEffect, useState } from "react"; // Importa React y otros hooks necesarios
 ...
 return (
    <div className="App">
     ...
     <hr style={{ border: '1px solid rgba(0, 0, 0, 0.23)', clear: 'both' }} /> 
      ...
      <div>
      <table style={{borderCollapse: 'collapse', width: '787px', height: '340px', textAlign: 'left'}}>
    ...
    {vehiculos.map((vehiculo, index) => (
        ...
        <tr key={vehiculo.id} style={{ cursor: 'pointer' }} onClick={() => { window.location.href = `/vehiculos/${vehiculo.id}` }}>
      ...
      <div style={{ textAlign: 'center', marginTop: "45px", height: '36px'}}>
